...
public class ColorDialogFragment extends DialogFragment
{
   ...
   public Dialog onCreateDialog(Bundle bundle)
   {
      ...
      // create dialog
      FragmentActivity colorFragmentActivity = getActivity();
      AlertDialog.Builder builder = new AlertDialog.Builder(colorFragmentActivity);
      View colorDialogView = colorFragmentActivity.getLayoutInflater().inflate(R.layout.fragment_color, null);
...
//       builder.setPositiveButton(R.string.button_set_color,
//               (dialog, id) -> doodleView.setDrawingColor(color)
//       );
